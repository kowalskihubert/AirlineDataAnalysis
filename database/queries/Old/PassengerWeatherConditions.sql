...
and (m.WeatherDelay > 0 or (Cancelled = 1 and CancellationCode = 'B'))
  and m.year between 2006 and 2008));

SELECT c.date, avg(WeatherDelay),avg(ArrDelay), avg(DepDelay) from ChicagoCovington c
...
SELECT WeatherDelay from ChicagoCovington c
